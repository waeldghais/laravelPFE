...
<html lang="en">
    ...
    <head>
        ...
        <!--Bootstrap Carousel-->
        <link type="text/css" rel="stylesheet" href="{{ asset('front') }}/css/carousel.css" />

        <link rel="stylesheet" href="{{ asset('front') }}/css/isotope/style.css">
    ...
    <body data-spy="scroll" data-target="#header">
                    ...
                    <div class="container">
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand custom_navbar-brand" href="#"><img src="{{ asset('front') }}/{{ asset('front') }}/img/logo.png" alt=""></a>
                            </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <div class="slider_overlay">
                            <img src="{{ asset('front') }}/{{ asset('front') }}/img/img1.jpg" alt="...">
                    ...
                    <div class="item">
                        <div class="slider_overlay">
                            <img src="{{ asset('front') }}/{{ asset('front') }}/img/img2.jpg" alt="...">
                            <div class="carousel-caption">
                                <div class="slider_text">
                                    <h3>Protect</h3>
                                    <h2>nature the environment</h2>
                    ...
                    <div class="item">
                        <div class="slider_overlay">
                            <img src="{{ asset('front') }}/{{ asset('front') }}/img/img3.jpg" alt="...">
                            <div class="carousel-caption">
                                <div class="slider_text">
                                    <h3>Protect</h3>
                                    <h2>nature the environment</h2>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="notes">
                                <div class="note blue">
                                    ...
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/environment.jpg" alt="">
                                </div>
                                <div class="note red">
                                    <div class="{{ asset('front') }}/img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/portfolio_1.jpg" alt="">
                                </div>
                                <div class="note green">
                                    <div class="img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/cliemate.jpg" alt="">
                                </div>
                                <div class="note yellow">
                                    <div class="img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/photography.jpg" alt="">
                                </div>
                                <div class="note black">
                                    <div class="img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/species.jpg" alt="">
                                </div>
                            </div>
                            <!--End of notes-->
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/tree.png" alt="">
                        ...
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/hand.png" alt="">
                                    <div class="counter_text">
                        ...
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/tuhnder.png" alt="">
                                    <div class="counter_text">
                        ...
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/cloud.png" alt="">
                                    <div class="counter_text">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <div class="event_img">
                                        <img src="{{ asset('front') }}/img/tree_cut_1.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 zero_mp">
                    ...
                    <div class="col-md-4">
                        <div class="event_news">
                            <div class="event_single_item fix"><div class="row">
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <div class="event_text text-center">
                                        <a href=""><h4>One Tree Thousand Hope</h4></a>
                            ...
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <div class="event_img">
                                        <img src="{{ asset('front') }}/{{ asset('front') }}/img/tree_cut_2.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                <div class="event_news_img floatleft">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/tree_cut_3.jpg" alt="">
                                </div>
                        ...
                        <div class="event_news">
                            <div class="event_single_item fix">
                                <div class="event_news_img floatleft">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/tree_cut_4.jpg" alt="">
                                </div>
                                <div class="event_news_text">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/climate_effect.jpg" alt="">
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/air_pollutuon.jpg" alt="">
                                </div>
                                <div class="blog_content">
                    ...
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="{{ asset('front') }}/{{ asset('front') }}/img/threat_bear.jpg" alt="">
                                </div>
                                <div class="blog_content">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="{{ asset('front') }}/img/audiojungle.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="{{ asset('front') }}/img/codecanyon.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="{{ asset('front') }}/img/graphicriver.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
        ...
        <!--Isotope-->
        <script src="{{ asset('front') }}/js/isotope/min/scripts-min.js"></script>
        <script src="{{ asset('front') }}/js/isotope/cells-by-row.js"></script>
        <script src="{{ asset('front') }}/js/isotope/isotope.pkgd.min.js"></script>
        <script src="{{ asset('front') }}/js/isotope/packery-mode.pkgd.min.js"></script>
        <script src="{{ asset('front') }}/js/isotope/scripts.js"></script>
        ...
        <script src="{{ asset('front') }}/js/jquery.localScroll.min.js"></script>
