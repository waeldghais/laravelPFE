...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card-header"><b>Modfier Pack {{$cours->titel}}</b></div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('pack.update',['id' => $cours->id ])}}" enctype="multipart/form-data"
                          method="GET">
                        ...
                        <div class="form-group">
                            ...
                            <div class="upload-btn-wrapper">
                                ...
                                <input type="file" name="photo" id="photo" accept="image/png , image/jpeg" value="{{$cours->photo}}"/>
                            </div>
                        </div>
                    ...
                    @foreach($vids as $vid)
                        @if($cours->id == $vid->pack_id)
                            <div class="col-md-4">
                                <video width="200" height="200" controls>
                                    <source src="{{ URL::asset($vid->video)}}" type="video/mp4">
                                </video>
                                <a href="{{route('supprimer_video',['id_vid'=>$vid->id])}}" style="color: red;" onclick="return myFunction();"><h4>Supprimer le video</h4></a>
                            </div>
                        @endif
                    @endforeach
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card-header"><b>Ajouter un video</b></div>
                <form action="{{route('video_pack.update',['id' => $cours->id ])}}" method="GET" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
