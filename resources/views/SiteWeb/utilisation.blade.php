                        ...
                        <div class="col-md-6" >
                            ...
                            <div class="float-left" style="margin-left: 50px;">
                                ...
                                <ol style="list-style-type:disc;" >
                                    <li><b>Enseignant</b></li>
                                </ol>
                                <div style="margin-left: 55px;">
                                <p>Pour commencer à travailler avec CLV rien de plus simple:</p>
                                    <ol>
                                        <li>Créer une demande .<a class="nav-link" href="{{ route('demande_enseigants.Denseigant') }}" style="color: #1d68a7">{{ __('Devenir Enseignant') }}</a></li>
                                        <li>Si vos étés acceptés <a href="{{ route('login') }}" style="color: #1d68a7">Se connecter </a>  au l'espace d'enseignant.</li>
                                        <li>Commencer à créer votre premier cours.</li>
                                    </ol>
                                </div>
                                </div>
                                <div style="margin-top: 50px;">
                                ...
                                <div style="margin-left: 55px;">
                                    <p>Pour commencer à étudier  avec CLV rien de plus simple:</p>
                                    <ol>
                                        <li>créer un <compte></compte> .<a class="nav-link" href="{{ route('Etudiant.registeretudiant') }}" style="color: #1d68a7">{{ __('Inscription') }}</a></li>
                                        <li><a href="{{ route('Etudiant.registeretudiant') }}" style="color: #1d68a7">Se connecter</a> au site.</li>
                                        <li>Commencer à suivre nos cours.</li>
                                    </ol>
                                </div>
                                    <video width="500" height="350" controls>
                                        <source src="{{ URL::asset('assets/vid/SansTitre.mp4')}}" type="video/mp4">
                                    </video>
                                </div>
                            </div>
