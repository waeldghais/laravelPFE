                            ...
                            @endif
                                ...
                                <div class="col-md-8" >
                                    <div class="tab-content">
                                        ...
                                        <P style="margin-left:8em"><a href="#" class="text-primary">Prix :</a> {{$cours->prix}} TND</P>
                                        @foreach($categories as $cat)
                                            @if ($cat->id == $cours->matiere_id)
                                        <P style="margin-left:8em"><a href="#" class="text-primary">Matiére :</a> {{$cat->name}} </P>
                                            @endif
                                        @endforeach
                                        <P style="margin-left:8em"><a href="#" class="text-primary">Ajouter le  :</a> {{$cours->created_at}}</P>
                                        @if ($etuds)
                                            <center><a href="{{route('acheter_cour',['id_etud'=>$etuds->id,'id_cour'=>$cours->id])}}" class="btn btn-success" >Acheter</a></center>
                                        @else
