                                        ...
                                        <div class="col-md-6">
                                            <div class="card bg-danger">
                                                <div class="card-body text-center">
                                                    <br>
                                                    <img class="card-img-top" src="{{ URL::asset($pack->photo)}}" alt="Card image cap" width="180px" height="150px">
                                                    <div class="card-body">
                                                        <center><b >{{$pack->titel}}</b>
                                                            <p class="card-text" >{{$pack->content}}.</p>
                                                            <b style="color: #3495e3">{{$pack->prix}} TND</b></center><br>
                                                        @if ($etuds)
                                                        ...
                                                        @endif
                                                        <a href="{{route('detaille_pack',['id_cour'=>$pack->id])}}" class="btn btn-info" >Détails</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
